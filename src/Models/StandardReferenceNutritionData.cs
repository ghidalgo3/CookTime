...
public class StandardReferenceNutritionData : USDANutritionData
{
    ...
    {
        if (this.FoodPortions == null) return 1.0;
    ...
    {
        if (this.FoodPortions == null) return null;
    ...
    {
        if (this.FoodPortions == null) return string.Empty;
    ...
    public JsonObject ToJsonObject()
    {
        var result = new JsonObject
        {
            ...
            ["nutrientConversionFactors"] = this.NutrientConversionFactors != null
                ? JsonNode.Parse(this.NutrientConversionFactors.RootElement.GetRawText())
                : null,
            ["foodCategory"] = this.FoodCategory != null
                ? JsonNode.Parse(this.FoodCategory.RootElement.GetRawText())
                : null,
            ["foodPortions"] = this.FoodPortions != null
                ? JsonNode.Parse(this.FoodPortions.RootElement.GetRawText())
                : null
        };
        return result;
    }
